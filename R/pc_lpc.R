#' Kernel PCA with Laplacian Kernel for Genomic Prediction
#'
#' This function fits kernel PCA models using a Laplacian kernel for genomic
#' prediction. It evaluates different sigma values for the Laplacian kernel.
...
#' @param sigmas A numeric vector of sigma values for the Laplacian kernel. Default is c(0.001, 0.01, 0.05, 0.1).
